...
fn write_frame(
    ...
    let n_atoms = system
        .group_get_n_atoms(group_name)
        .expect("FATAL GROAN ERROR | io::gro_io::write_frame | Group does not exist (1).");
    ...
    for atom in system
        ...
        .expect("FATAL GROAN ERROR | io::gro_io::write_frame | Group does not exist (2).")
    {
