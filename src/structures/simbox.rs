...
impl SimBox {
    ...
    pub fn from_lengths_angles(lengths: Vector3D, angles: Vector3D) -> Self {
        ...
        if angles.x == 90.0 && angles.y == 90.0 && angles.z == 90.0 {
            ...
            simbox.v3z = (lengths.z*lengths.z - simbox.v3x*simbox.v3x - simbox.v3y*simbox.v3y).sqrt();
...
mod tests {
    ...
    fn from_lengths_angles_1() {
        let simbox = SimBox::from_lengths_angles([5.297, 4.863, 2.976].into(), [90.0, 90.0, 90.0].into());
    ...
    fn from_lengths_angles_2() {
        let simbox = SimBox::from_lengths_angles([5.297, 4.863, 2.976].into(), [120.0, 70.0, 80.0].into());
    ...
    fn from_lengths_angles_3() {
        let simbox = SimBox::from_lengths_angles([6.26832, 6.26832, 6.26832].into(), [60.0, 60.0, 90.0].into());
    ...
    fn from_lengths_angles_4() {
        let simbox = SimBox::from_lengths_angles([6.26832, 6.26832, 6.26832].into(), [70.53, 109.47, 70.53].into());
    ...
    #[test]
    fn from_array9() {
        let arr = [6.26832, 5.90987, 5.11825, 0.0, 0.0, 2.08931, 0.0, -2.08931, 2.95467];
    ...
    fn from_array9_panics_1() {
        let arr = [6.26832, 5.90987, 5.11825, 1.3, 0.0, 2.08931, 0.0, -2.08931, 2.95467];
    ...
    fn from_array9_panics_2() {
        let arr = [6.26832, 5.90987, 5.11825, 0.0, 2.5634, 2.08931, 0.0, -2.08931, 2.95467];
        let _simbox = SimBox::from(arr);
    }
    ...
    fn from_array9_panics_3() {
        let arr = [6.26832, 5.90987, 5.11825, 0.0, 0.0, 2.08931, -1.322, -2.08931, 2.95467];
        let _simbox = SimBox::from(arr);
    }
    ...
    fn from_array9_panics_4() {
        let arr = [6.26832, 5.90987, 5.11825, 1.3, 2.5634, 2.08931, -1.322, -2.08931, 2.95467];
        let _simbox = SimBox::from(arr);
    }
}